...
if __name__ == "__main__":
    ...
    meuPerfil = Perfil()
    msg = NotificadorMensagem(meuPerfil, seguidores_mensagem)
    push = NotificadorPushNotification(meuPerfil, seguidores_push_notification)
    email = NotificadorEmail(meuPerfil, seguidores_email)

    meuPerfil.adicionar_post("Olá universo da programação!")
    meuPerfil.remover_sistema_de_notificacao(email)
    print("----")
    meuPerfil.adicionar_post("Olá universo da programação!")
